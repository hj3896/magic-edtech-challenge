...
import { permit } from "../middleware/role.middleware";
...
router.get("/tasks", authMiddleware, permit("admin", "user"), getTasks);
router.get("/tasks/:id", authMiddleware, permit("admin", "user"), getTaskForId);
